...
public class MainRecipe2list4Adapter extends RecyclerView.Adapter<MainRecipe2list4Adapter.ViewHolder> implements ClickListener {
    ArrayList<WeekRecipeDTO> arrayList;
    ClickListener listener;

    public MainRecipe2list4Adapter(ArrayList<WeekRecipeDTO> arrayList) {
