...
public class WeekRecipe extends AsyncTask<Void, Void, Void> {
    ArrayList<WeekRecipeDTO> weekArrayList;
    ...
    public WeekRecipe(ArrayList<WeekRecipeDTO> weekArrayList, WeekRecipeAdapter adapter) {
    ...
    protected Void doInBackground(Void... voids) {
        try {
            ...
            String postURL = CommonMethod.ipConfig + "/weekRecipe";
            // 전송
    ...
    public void readJsonStream(InputStream inputStream) throws IOException {
        ...
        try {
            ...
            while (reader.hasNext()) {
                ...
                Log.d("TAG:week", "readJsonStream: " + weekArrayList + "<>" + weekArrayList.size());
