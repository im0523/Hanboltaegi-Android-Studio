...
public class MainRecipe3list1 extends AsyncTask<Void, Void, Void> {
    ...
    public MainRecipe3list1(ArrayList<WeekRecipeDTO> arrayList, MainRecipe3list1Adapter adapter) {
    ...
    protected Void doInBackground(Void... voids) {
        try {
            ...
            String postURL = CommonMethod.ipConfig + "/maincat3s1Recipe";
            // 전송
