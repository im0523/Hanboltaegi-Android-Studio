...
public class SituationRecipe extends AsyncTask<Void, Void, Void> {
    ArrayList<WeekRecipeDTO> monthArrayList;
    ...
    public SituationRecipe(ArrayList<WeekRecipeDTO> monthArrayList, MonthRecipeAdapter adapter) {
    ...
    protected Void doInBackground(Void... voids) {
        try {
            ...
            String postURL = CommonMethod.ipConfig + "/monthRecipe";
            // 전송
    ...
    public void readJsonStream(InputStream inputStream) throws IOException {
        ...
        try {
            ...
            while (reader.hasNext()) {
                monthArrayList.add(readMessage(reader));
