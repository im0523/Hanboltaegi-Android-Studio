...
import com.example.han2.Atask.MainRecipe2list5;
...
public class MainRecipe2_list5 extends Fragment {
    MainRecipe2list5 mainRecipe2List5;
    MainRecipe2list5Adapter adapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_recipe2_list5, container, false);
        ...
        adapter = new MainRecipe2list5Adapter(arrayList);
        ...
        mainRecipe2List5 = new MainRecipe2list5(arrayList, adapter);
        mainRecipe2List5.execute();
