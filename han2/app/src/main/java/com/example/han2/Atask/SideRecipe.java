...
public class SideRecipe extends AsyncTask<Void, Void, Void> {
    ArrayList<WeekRecipeDTO> sideArrayList;
    ...
    public SideRecipe(ArrayList<WeekRecipeDTO> sideArrayList, SideRecipeAdapter adapter) {
        this.sideArrayList = sideArrayList;
    ...
    protected Void doInBackground(Void... voids) {
        try {
            ...
            String postURL = CommonMethod.ipConfig + "/SideRecipe";
            // 전송
    ...
    public void readJsonStream(InputStream inputStream) throws IOException {
        ...
        try {
            ...
            while (reader.hasNext()) {
                sideArrayList.add(readMessage(reader));
