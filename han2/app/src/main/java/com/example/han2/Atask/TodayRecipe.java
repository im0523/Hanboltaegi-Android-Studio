...
public class TodayRecipe extends AsyncTask<Void, Void, Void> {
    ArrayList<TodayRecipeDTO> todayArrayList;
    TodayRecipeAdapter adapter;
    ...
    public TodayRecipe(ArrayList<TodayRecipeDTO> todayArrayList, TodayRecipeAdapter adapter) {
    ...
    protected Void doInBackground(Void... voids) {
        try {
            ...
            String postURL = CommonMethod.ipConfig + "/todayRecipe";
            // 전송
    ...
    public void readJsonStream(InputStream inputStream) throws IOException {
        ...
        try {
            ...
            while (reader.hasNext()) {
                todayArrayList.add(readMessage(reader));
                Log.d("toady", "readJsonStream: " + todayArrayList + "<>" + todayArrayList.size());
            }
            reader.endArray();
        } finally {
            reader.close();
    ...
    public TodayRecipeDTO readMessage(JsonReader reader) throws IOException {
        ...
        return new TodayRecipeDTO(nickname, title, recipe_id, subtitle, portion, time, cat1, cat2, cat3, cat4, degree, writedate, pid, good, scrap, imagepath,
                image1, image2, image3, image4, image5, image6, image7, image8, image9, image10, text1, text2, text3, text4, text5, text6, text7, text8, text9, text10, material_name0, material_unit0, material_name1, material_unit1, material_name2, material_unit2,
                material_name3, material_unit3, material_name4, material_unit4, material_name5, material_unit5,
                material_name6, material_unit6, material_name7, material_unit7, material_name8, material_unit8,
                material_name9, material_unit9, material_name10, material_unit10, material_name11, material_unit11,
