...
public class JoongbokNick extends AsyncTask<Void, Void, Void> {

    String nickname;

    public JoongbokNick(String nickname) {
    ...
    protected Void doInBackground(Void... voids) {
        try {
            ...
            String postURL = ipConfig + "/JoongbokNick";
            // 전송
    ...
    public JoongbokDTO readMessage(JsonReader reader) throws IOException {
        ...
        reader.endObject();
        Log.d("login:memberdto", nickname );
