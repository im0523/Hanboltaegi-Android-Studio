...
public class MainRecipe2list5 extends AsyncTask<Void, Void, Void> {
    ...
    public MainRecipe2list5(ArrayList<WeekRecipeDTO> arrayList, MainRecipe2list5Adapter adapter) {
    ...
    protected Void doInBackground(Void... voids) {
        try {
            ...
            String postURL = CommonMethod.ipConfig + "/maincat2s4Recipe";
            // 전송
