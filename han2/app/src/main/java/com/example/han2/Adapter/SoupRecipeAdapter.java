...
public class SoupRecipeAdapter extends RecyclerView.Adapter<SoupRecipeAdapter.ViewHolder> implements RecipeClickListener {
    ArrayList<WeekRecipeDTO> arrayList;
    RecipeClickListener listener;

    public SoupRecipeAdapter(ArrayList<WeekRecipeDTO> arrayList) {
