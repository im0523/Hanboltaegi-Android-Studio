...
public class MainRecipe2list2 extends AsyncTask<Void, Void, Void> {
    ...
    public MainRecipe2list2(ArrayList<WeekRecipeDTO> arrayList, MainRecipe2list2Adapter adapter) {
    ...
    protected Void doInBackground(Void... voids) {
        try {
            ...
            String postURL = CommonMethod.ipConfig + "/maincat2s1Recipe";
            // 전송
