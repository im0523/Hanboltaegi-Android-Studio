...
import com.example.han2.Atask.NoodleRecipe;
import com.example.han2.Dto.WeekRecipeDTO;
import com.example.han2.R;

import java.util.ArrayList;

public class KindList4 extends Fragment {


    NoodleRecipe noodleRecipe;
    NoodleRecipeAdapter adapter;
    ...
    public View onCreateView(@NonNull final LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_noodle_recipe, container, false);
        ...
        //레시피 데이터받기
        ArrayList<WeekRecipeDTO> NoodleArrayList = new ArrayList<>();
        adapter = new NoodleRecipeAdapter(NoodleArrayList);
        recyclerView = view.findViewById(R.id.recyclerView_noodle_recipe);
        LinearLayoutManager layoutManager1 = new LinearLayoutManager(getContext(), RecyclerView.VERTICAL, false);
        recyclerView.setLayoutManager(layoutManager1);
        recyclerView.setAdapter(adapter);
        recyclerView.setNestedScrollingEnabled(false);
        noodleRecipe = new NoodleRecipe(NoodleArrayList, adapter);
        noodleRecipe.execute();
