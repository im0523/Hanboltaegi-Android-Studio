...
public class GitaRecipe extends AsyncTask<Void, Void, Void> {
    ArrayList<WeekRecipeDTO> gitaArrayList;
    ...
    public GitaRecipe(ArrayList<WeekRecipeDTO> gitaArrayList, GitaRecipeAdapter adapter) {
        this.gitaArrayList = gitaArrayList;
    ...
    protected Void doInBackground(Void... voids) {
        try {
            ...
            String postURL = CommonMethod.ipConfig + "/GitaRecipe";
            // 전송
    ...
    public void readJsonStream(InputStream inputStream) throws IOException {
        ...
        try {
            ...
            while (reader.hasNext()) {
                gitaArrayList.add(readMessage(reader));
