...
public class MainRecipe2list3 extends AsyncTask<Void, Void, Void> {
    ...
    public MainRecipe2list3(ArrayList<WeekRecipeDTO> arrayList, MainRecipe2list3Adapter adapter) {
    ...
    protected Void doInBackground(Void... voids) {
        try {
            ...
            String postURL = CommonMethod.ipConfig + "/maincat2s2Recipe";
            // 전송
