...
public class SourceRecipe extends AsyncTask<Void, Void, Void> {
    ArrayList<WeekRecipeDTO> sourceArrayList;
    ...
    public SourceRecipe(ArrayList<WeekRecipeDTO> sourceArrayList, SourceRecipeAdapter adapter) {
    ...
    protected Void doInBackground(Void... voids) {
        try {
            ...
            String postURL = CommonMethod.ipConfig + "/SourceRecipe";
            // 전송
    ...
    public void readJsonStream(InputStream inputStream) throws IOException {
        ...
        try {
            ...
            while (reader.hasNext()) {
                sourceArrayList.add(readMessage(reader));
