...
public class BbangRecipe extends AsyncTask<Void, Void, Void> {
    ArrayList<WeekRecipeDTO> bbangArrayList;
    ...
    public BbangRecipe(ArrayList<WeekRecipeDTO> bbangArrayList, BbangRecipeAdapter adapter) {
        this.bbangArrayList = bbangArrayList;
    ...
    protected Void doInBackground(Void... voids) {
        try {
            ...
            String postURL = CommonMethod.ipConfig + "/BbangRecipe";
            // 전송
    ...
    public void readJsonStream(InputStream inputStream) throws IOException {
        ...
        try {
            ...
            while (reader.hasNext()) {
                bbangArrayList.add(readMessage(reader));
