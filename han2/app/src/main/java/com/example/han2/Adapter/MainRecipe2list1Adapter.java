...
public class MainRecipe2list1Adapter extends RecyclerView.Adapter<MainRecipe2list1Adapter.ViewHolder> implements ClickListener {
    ArrayList<WeekRecipeDTO> arrayList;
    ClickListener listener;

    public MainRecipe2list1Adapter(ArrayList<WeekRecipeDTO> arrayList) {
