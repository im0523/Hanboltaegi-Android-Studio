...
public class MainRecipe2list6Adapter extends RecyclerView.Adapter<MainRecipe2list6Adapter.ViewHolder> implements ClickListener {
    ArrayList<WeekRecipeDTO> arrayList;
    ClickListener listener;

    public MainRecipe2list6Adapter(ArrayList<WeekRecipeDTO> arrayList) {
