...
import com.example.han2.Atask.DessertRecipe;
import com.example.han2.Dto.WeekRecipeDTO;
import com.example.han2.R;

import java.util.ArrayList;

public class KindList3 extends Fragment {


    DessertRecipe dessertRecipe;
    DessertRecipeAdapter adapter;
    ...
    public View onCreateView(@NonNull final LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_dessert_recipe, container, false);
        ...
        //레시피 데이터받기
        ArrayList<WeekRecipeDTO> DessertArrayList = new ArrayList<>();
        adapter = new DessertRecipeAdapter(DessertArrayList);
        recyclerView = view.findViewById(R.id.recyclerView_dessert_recipe);
        LinearLayoutManager layoutManager1 = new LinearLayoutManager(getContext(), RecyclerView.VERTICAL, false);
        recyclerView.setLayoutManager(layoutManager1);
        recyclerView.setAdapter(adapter);
        recyclerView.setNestedScrollingEnabled(false);
        dessertRecipe = new DessertRecipe(DessertArrayList, adapter);
        dessertRecipe.execute();
