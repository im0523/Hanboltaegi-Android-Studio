...
public class MainRecipe4list4 extends AsyncTask<Void, Void, Void> {
    ...
    public MainRecipe4list4(ArrayList<WeekRecipeDTO> arrayList, MainRecipe4list4Adapter adapter) {
    ...
    protected Void doInBackground(Void... voids) {
        try {
            ...
            String postURL = CommonMethod.ipConfig + "/maincat4s4Recipe";
            // 전송
