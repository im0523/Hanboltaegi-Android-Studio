...
public class CommunityUpdate extends AsyncTask<Void, Void, Void> {

    String no, content, nickname, userid;

    public CommunityUpdate(String no, String content, String nickname, String userid) {
        this.no = no;
    ...
    protected Void doInBackground(Void... voids) {
        try {
            ...
            Log.d("CommunityUpdate", content);
            Log.d("CommunityUpdate", no);


            postURL = ipConfig + "/CommunityUpdate";
            // 전송
