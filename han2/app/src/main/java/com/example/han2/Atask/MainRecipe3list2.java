...
public class MainRecipe3list2 extends AsyncTask<Void, Void, Void> {
    ...
    public MainRecipe3list2(ArrayList<WeekRecipeDTO> arrayList, MainRecipe3list2Adapter adapter) {
    ...
    protected Void doInBackground(Void... voids) {
        try {
            ...
            String postURL = CommonMethod.ipConfig + "/maincat3s2Recipe";
            // 전송
