...
public class DessertRecipe extends AsyncTask<Void, Void, Void> {
    ArrayList<WeekRecipeDTO> dessertArrayList;
    ...
    public DessertRecipe(ArrayList<WeekRecipeDTO> dessertArrayList, DessertRecipeAdapter adapter) {
        this.dessertArrayList = dessertArrayList;
    ...
    protected Void doInBackground(Void... voids) {
        try {
            ...
            String postURL = CommonMethod.ipConfig + "/DessertRecipe";
            // 전송
    ...
    public void readJsonStream(InputStream inputStream) throws IOException {
        ...
        try {
            ...
            while (reader.hasNext()) {
                dessertArrayList.add(readMessage(reader));
