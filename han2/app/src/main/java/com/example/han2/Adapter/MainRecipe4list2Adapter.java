...
public class MainRecipe4list2Adapter extends RecyclerView.Adapter<MainRecipe4list2Adapter.ViewHolder> implements ClickListener {
    ArrayList<WeekRecipeDTO> arrayList;
    ClickListener listener;

    public MainRecipe4list2Adapter(ArrayList<WeekRecipeDTO> arrayList) {
