...
public class MainRecipe4list1Adapter extends RecyclerView.Adapter<MainRecipe4list1Adapter.ViewHolder> implements ClickListener {
    ArrayList<WeekRecipeDTO> arrayList;
    ClickListener listener;

    public MainRecipe4list1Adapter(ArrayList<WeekRecipeDTO> arrayList) {
