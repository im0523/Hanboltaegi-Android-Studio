...
public class SaladRecipe extends AsyncTask<Void, Void, Void> {
    ArrayList<WeekRecipeDTO> saladArrayList;
    ...
    public SaladRecipe(ArrayList<WeekRecipeDTO> saladArrayList, SaladRecipeAdapter adapter) {
        this.saladArrayList = saladArrayList;
    ...
    protected Void doInBackground(Void... voids) {
        try {
            ...
            String postURL = CommonMethod.ipConfig + "/SaladRecipe";
            // 전송
    ...
    public void readJsonStream(InputStream inputStream) throws IOException {
        ...
        try {
            ...
            while (reader.hasNext()) {
                saladArrayList.add(readMessage(reader));
    ...
    public WeekRecipeDTO readMessage(JsonReader reader) throws IOException {
        ...
        while (reader.hasNext()) {
            ...
            } else if (readStr.equals("material_name13")) {
