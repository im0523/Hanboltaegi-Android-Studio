...
public class MainRecipe3list3 extends AsyncTask<Void, Void, Void> {
    ...
    public MainRecipe3list3(ArrayList<WeekRecipeDTO> arrayList, MainRecipe3list3Adapter adapter) {
    ...
    protected Void doInBackground(Void... voids) {
        try {
            ...
            String postURL = CommonMethod.ipConfig + "/maincat3s3Recipe";
            // 전송
