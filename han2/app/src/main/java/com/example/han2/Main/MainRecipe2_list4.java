...
import com.example.han2.Atask.MainRecipe2list4;
...
public class MainRecipe2_list4 extends Fragment {
    MainRecipe2list4 mainRecipe2List4;
    MainRecipe2list4Adapter adapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_recipe2_list4, container, false);
        ...
        adapter = new MainRecipe2list4Adapter(arrayList);
        ...
        mainRecipe2List4 = new MainRecipe2list4(arrayList, adapter);
        mainRecipe2List4.execute();
