...
public class MainRecipe4list1 extends AsyncTask<Void, Void, Void> {
    ...
    public MainRecipe4list1(ArrayList<WeekRecipeDTO> arrayList, MainRecipe4list1Adapter adapter) {
    ...
    protected Void doInBackground(Void... voids) {
        try {
            ...
            String postURL = CommonMethod.ipConfig + "/maincat4s1Recipe";
            // 전송
