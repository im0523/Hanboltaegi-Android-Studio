...
public class SearchRecipe extends AsyncTask<Void, Void, Void> {
    private  static  final String TAG = "SearchRecipe";

    //생성자
    ArrayList<MyRecipeDTO> RecipeArrayList;
    RecipeAdapter adapter;

    public SearchRecipe(ArrayList<MyRecipeDTO> recipeArrayList, RecipeAdapter adapter) {
    ...
    protected Void doInBackground(Void... voids) {
        ...
        try {
            ...
            String postURL = ipConfig + "/SearchRecipe";
