...
public class MainRecipe2list1 extends AsyncTask<Void, Void, Void> {
    ...
    public MainRecipe2list1(ArrayList<WeekRecipeDTO> arrayList, MainRecipe2list1Adapter adapter) {
    ...
    protected Void doInBackground(Void... voids) {
        try {
            ...
            String postURL = CommonMethod.ipConfig + "/allRecipe";
            // 전송
