...
public class GitaRecipeAdapter extends RecyclerView.Adapter<GitaRecipeAdapter.ViewHolder> implements RecipeClickListener {
    ArrayList<WeekRecipeDTO> arrayList;
    RecipeClickListener listener;

    public GitaRecipeAdapter(ArrayList<WeekRecipeDTO> arrayList) {
