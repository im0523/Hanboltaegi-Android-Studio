...
import com.example.han2.Atask.MainRecipe4list4;
...
public class MainRecipe4_list4 extends Fragment {
    MainRecipe4list4 mainRecipe4List4;
    MainRecipe4list4Adapter adapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_recipe4_list4, container, false);
        ...
        adapter = new MainRecipe4list4Adapter(arrayList);
        ...
        mainRecipe4List4 = new MainRecipe4list4(arrayList, adapter);
        mainRecipe4List4.execute();
