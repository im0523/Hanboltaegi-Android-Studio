...
public class WeekRecipeAdapter extends RecyclerView.Adapter<WeekRecipeAdapter.ViewHolder> implements RecipeClickListener {
    ArrayList<WeekRecipeDTO> arrayList;
    RecipeClickListener listener;

    public WeekRecipeAdapter(ArrayList<WeekRecipeDTO> arrayList) {
