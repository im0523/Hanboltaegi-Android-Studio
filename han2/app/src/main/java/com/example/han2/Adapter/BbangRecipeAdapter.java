...
public class BbangRecipeAdapter extends RecyclerView.Adapter<BbangRecipeAdapter.ViewHolder> implements RecipeClickListener {
    ArrayList<WeekRecipeDTO> arrayList;
    RecipeClickListener listener;

    public BbangRecipeAdapter(ArrayList<WeekRecipeDTO> arrayList) {
