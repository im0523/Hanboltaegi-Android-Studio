...
public class MainRecipe3list2Adapter extends RecyclerView.Adapter<MainRecipe3list2Adapter.ViewHolder> implements ClickListener {
    ArrayList<WeekRecipeDTO> arrayList;
    ClickListener listener;

    public MainRecipe3list2Adapter(ArrayList<WeekRecipeDTO> arrayList) {
