...
public class MainRecipe2list6 extends AsyncTask<Void, Void, Void> {
    ...
    public MainRecipe2list6(ArrayList<WeekRecipeDTO> arrayList, MainRecipe2list6Adapter adapter) {
    ...
    protected Void doInBackground(Void... voids) {
        try {
            ...
            String postURL = CommonMethod.ipConfig + "/maincat2s5Recipe";
            // 전송
