...
import com.example.han2.Atask.MainRecipe4list2;
...
public class MainRecipe4_list2 extends Fragment {
    MainRecipe4list2 mainRecipe4List2;
    MainRecipe4list2Adapter adapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_recipe4_list2, container, false);
        ...
        adapter = new MainRecipe4list2Adapter(arrayList);
        ...
        mainRecipe4List2 = new MainRecipe4list2(arrayList, adapter);
        mainRecipe4List2.execute();
