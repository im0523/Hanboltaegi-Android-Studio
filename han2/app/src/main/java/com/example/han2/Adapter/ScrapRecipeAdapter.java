...
public class ScrapRecipeAdapter extends RecyclerView.Adapter<ScrapRecipeAdapter.ViewHolder> implements RecipeClickListener {
    ArrayList<WeekRecipeDTO> arrayList;
    RecipeClickListener listener;


    public ScrapRecipeAdapter(ArrayList<WeekRecipeDTO> arrayList) {
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, final int position) {
        final WeekRecipeDTO item = arrayList.get(position);   //index에 있는 position을 가져와 item 에 담음
        holder.setItem(item);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        public TextView textView1, textView2, tvWritedate;
