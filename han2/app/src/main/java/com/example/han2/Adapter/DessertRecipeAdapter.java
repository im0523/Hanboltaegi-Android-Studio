...
public class DessertRecipeAdapter extends RecyclerView.Adapter<DessertRecipeAdapter.ViewHolder> implements RecipeClickListener {
    ArrayList<WeekRecipeDTO> arrayList;
    RecipeClickListener listener;

    public DessertRecipeAdapter(ArrayList<WeekRecipeDTO> arrayList) {
