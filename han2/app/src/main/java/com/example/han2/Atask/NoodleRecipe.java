...
public class NoodleRecipe extends AsyncTask<Void, Void, Void> {
    ArrayList<WeekRecipeDTO> noodleArrayList;
    ...
    public NoodleRecipe(ArrayList<WeekRecipeDTO> noodleArrayList, NoodleRecipeAdapter adapter) {
        this.noodleArrayList = noodleArrayList;
    ...
    protected Void doInBackground(Void... voids) {
        try {
            ...
            String postURL = CommonMethod.ipConfig + "/NoodleRecipe";
            // 전송
    ...
    public void readJsonStream(InputStream inputStream) throws IOException {
        ...
        try {
            ...
            while (reader.hasNext()) {
                noodleArrayList.add(readMessage(reader));
