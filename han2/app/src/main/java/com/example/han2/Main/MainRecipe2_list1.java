...
import com.example.han2.Atask.MainRecipe2list1;
...
public class MainRecipe2_list1 extends Fragment {
    MainRecipe2list1 mainRecipe2List1;
    MainRecipe2list1Adapter adapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_recipe2_list1, container, false);
        ...
        adapter = new MainRecipe2list1Adapter(arrayList);
        ...
        mainRecipe2List1 = new MainRecipe2list1(arrayList, adapter);
        mainRecipe2List1.execute();
