...
import com.example.han2.Atask.MainRecipe2list3;
...
public class MainRecipe2_list3 extends Fragment {
    MainRecipe2list3 mainRecipe2List3;
    MainRecipe2list3Adapter adapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_recipe2_list3, container, false);
        ...
        adapter = new MainRecipe2list3Adapter(arrayList);
        ...
        mainRecipe2List3 = new MainRecipe2list3(arrayList, adapter);
        mainRecipe2List3.execute();
