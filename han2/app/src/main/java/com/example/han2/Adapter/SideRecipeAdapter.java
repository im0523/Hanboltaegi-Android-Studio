...
public class SideRecipeAdapter extends RecyclerView.Adapter<SideRecipeAdapter.ViewHolder> implements RecipeClickListener {
    ArrayList<WeekRecipeDTO> arrayList;
    RecipeClickListener listener;

    public SideRecipeAdapter(ArrayList<WeekRecipeDTO> arrayList) {
