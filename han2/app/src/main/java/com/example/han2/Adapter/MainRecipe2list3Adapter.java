...
public class MainRecipe2list3Adapter extends RecyclerView.Adapter<MainRecipe2list3Adapter.ViewHolder> implements ClickListener {
    ArrayList<WeekRecipeDTO> arrayList;
    ClickListener listener;

    public MainRecipe2list3Adapter(ArrayList<WeekRecipeDTO> arrayList) {
