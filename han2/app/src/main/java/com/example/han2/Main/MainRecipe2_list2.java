...
import com.example.han2.Atask.MainRecipe2list2;
...
public class MainRecipe2_list2 extends Fragment {
    MainRecipe2list2 mainRecipe2List2;
    MainRecipe2list2Adapter adapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_recipe2_list2, container, false);
        ...
        adapter = new MainRecipe2list2Adapter(arrayList);
        ...
        mainRecipe2List2 = new MainRecipe2list2(arrayList, adapter);
        mainRecipe2List2.execute();
