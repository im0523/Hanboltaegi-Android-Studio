...
public class SoupRecipe extends AsyncTask<Void, Void, Void> {
    ArrayList<WeekRecipeDTO> soupArrayList;
    ...
    public SoupRecipe(ArrayList<WeekRecipeDTO> soupArrayList, SoupRecipeAdapter adapter) {
        this.soupArrayList = soupArrayList;
    ...
    protected Void doInBackground(Void... voids) {
        try {
            ...
            String postURL = CommonMethod.ipConfig + "/SoupRecipe";
            // 전송
    ...
    public void readJsonStream(InputStream inputStream) throws IOException {
        ...
        try {
            ...
            while (reader.hasNext()) {
                soupArrayList.add(readMessage(reader));
