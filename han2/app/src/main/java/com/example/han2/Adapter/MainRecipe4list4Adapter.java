...
public class MainRecipe4list4Adapter extends RecyclerView.Adapter<MainRecipe4list4Adapter.ViewHolder> implements ClickListener {
    ArrayList<WeekRecipeDTO> arrayList;
    ClickListener listener;

    public MainRecipe4list4Adapter(ArrayList<WeekRecipeDTO> arrayList) {
