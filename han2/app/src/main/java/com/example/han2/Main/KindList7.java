...
import com.example.han2.Atask.SaladRecipe;
import com.example.han2.Dto.WeekRecipeDTO;
import com.example.han2.R;

import java.util.ArrayList;

public class KindList7 extends Fragment {


    SaladRecipe saladRecipe;
    SaladRecipeAdapter adapter;
    ...
    public View onCreateView(@NonNull final LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_salad_recipe, container, false);
        ...
        //레시피 데이터받기
        ArrayList<WeekRecipeDTO> SaladArrayList = new ArrayList<>();
        adapter = new SaladRecipeAdapter(SaladArrayList);
        recyclerView = view.findViewById(R.id.recyclerView_salad_recipe);
        LinearLayoutManager layoutManager1 = new LinearLayoutManager(getContext(), RecyclerView.VERTICAL, false);
        recyclerView.setLayoutManager(layoutManager1);
        recyclerView.setAdapter(adapter);
        recyclerView.setNestedScrollingEnabled(false);
        saladRecipe = new SaladRecipe(SaladArrayList, adapter);
        saladRecipe.execute();
