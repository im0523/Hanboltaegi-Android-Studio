...
public class SaladRecipeAdapter extends RecyclerView.Adapter<SaladRecipeAdapter.ViewHolder> implements RecipeClickListener {
    ArrayList<WeekRecipeDTO> arrayList;
    RecipeClickListener listener;

    public SaladRecipeAdapter(ArrayList<WeekRecipeDTO> arrayList) {
