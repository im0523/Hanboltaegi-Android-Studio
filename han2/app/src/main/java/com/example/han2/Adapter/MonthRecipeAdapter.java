...
public class MonthRecipeAdapter extends RecyclerView.Adapter<MonthRecipeAdapter.ViewHolder> implements RecipeClickListener {
    ArrayList<WeekRecipeDTO> arrayList;
    RecipeClickListener listener;

    public MonthRecipeAdapter(ArrayList<WeekRecipeDTO> arrayList) {
