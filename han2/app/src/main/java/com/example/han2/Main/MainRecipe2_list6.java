...
import com.example.han2.Atask.MainRecipe2list6;
...
public class MainRecipe2_list6 extends Fragment {
    MainRecipe2list6 mainRecipe2List6;
    MainRecipe2list6Adapter adapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_recipe2_list6, container, false);
        ...
        adapter = new MainRecipe2list6Adapter(arrayList);
        ...
        mainRecipe2List6 = new MainRecipe2list6(arrayList, adapter);
        mainRecipe2List6.execute();
