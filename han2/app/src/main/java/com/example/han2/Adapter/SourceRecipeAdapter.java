...
public class SourceRecipeAdapter extends RecyclerView.Adapter<SourceRecipeAdapter.ViewHolder> implements RecipeClickListener {
    ArrayList<WeekRecipeDTO> arrayList;
    RecipeClickListener listener;

    public SourceRecipeAdapter(ArrayList<WeekRecipeDTO> arrayList) {
