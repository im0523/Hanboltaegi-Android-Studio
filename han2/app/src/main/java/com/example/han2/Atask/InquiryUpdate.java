...
public class InquiryUpdate extends AsyncTask<Void, Void, Void> {

    String title, nickname, content, id, no;

    public InquiryUpdate(String title, String nickname, String content, String id, String no) {
        this.title = title;
    ...
    protected Void doInBackground(Void... voids) {
        ...
        try {
            ...
            String postURL = ipConfig + "/InquiryUpdate";
            // 전송
