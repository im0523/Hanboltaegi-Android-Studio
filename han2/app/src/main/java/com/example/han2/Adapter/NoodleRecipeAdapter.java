...
public class NoodleRecipeAdapter extends RecyclerView.Adapter<NoodleRecipeAdapter.ViewHolder> implements RecipeClickListener {
    ArrayList<WeekRecipeDTO> arrayList;
    RecipeClickListener listener;

    public NoodleRecipeAdapter(ArrayList<WeekRecipeDTO> arrayList) {
