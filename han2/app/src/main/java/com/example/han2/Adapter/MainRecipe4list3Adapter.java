...
public class MainRecipe4list3Adapter extends RecyclerView.Adapter<MainRecipe4list3Adapter.ViewHolder> implements ClickListener {
    ArrayList<WeekRecipeDTO> arrayList;
    ClickListener listener;

    public MainRecipe4list3Adapter(ArrayList<WeekRecipeDTO> arrayList) {
