...
public class MainRecipe3list1Adapter extends RecyclerView.Adapter<MainRecipe3list1Adapter.ViewHolder> implements ClickListener {
    ArrayList<WeekRecipeDTO> arrayList;
    ClickListener listener;

    public MainRecipe3list1Adapter(ArrayList<WeekRecipeDTO> arrayList) {
