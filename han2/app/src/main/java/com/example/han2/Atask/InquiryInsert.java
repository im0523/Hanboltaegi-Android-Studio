...
public class InquiryInsert extends AsyncTask<Void, Void, Void> {

    String title, nickname,  content, id;

    public InquiryInsert(String title, String nickname, String content, String id) {
        this.title = title;
    ...
    protected Void doInBackground(Void... voids) {
        ...
        try {
            ...
            String postURL = ipConfig + "/InquiryInsert";
            // 전송
