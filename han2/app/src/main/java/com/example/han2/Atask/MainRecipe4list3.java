...
public class MainRecipe4list3 extends AsyncTask<Void, Void, Void> {
    ...
    public MainRecipe4list3(ArrayList<WeekRecipeDTO> arrayList, MainRecipe4list3Adapter adapter) {
    ...
    protected Void doInBackground(Void... voids) {
        try {
            ...
            String postURL = CommonMethod.ipConfig + "/maincat4s3Recipe";
            // 전송
