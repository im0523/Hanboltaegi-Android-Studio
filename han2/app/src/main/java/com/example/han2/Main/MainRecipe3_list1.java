...
import com.example.han2.Atask.MainRecipe3list1;
...
public class MainRecipe3_list1 extends Fragment {
    MainRecipe3list1 mainRecipe3List1;
    MainRecipe3list1Adapter adapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_recipe3_list1, container, false);
        ...
        adapter = new MainRecipe3list1Adapter(arrayList);
        ...
        mainRecipe3List1 = new MainRecipe3list1(arrayList, adapter);
        mainRecipe3List1.execute();
