...
public class ScrapRecipe extends AsyncTask<Void, Void, Void> {
    ArrayList<WeekRecipeDTO> scrapArrayList;
    ...
    public ScrapRecipe(ArrayList<WeekRecipeDTO> scrapArrayList, ScrapRecipeAdapter adapter, String scr_userid) {
        this.scrapArrayList = scrapArrayList;
    ...
    protected Void doInBackground(Void... voids) {
        try {
            ...
            String postURL = CommonMethod.ipConfig + "/ScrapRecipe";
            // 전송
    ...
    public void readJsonStream(InputStream inputStream) throws IOException {
        ...
        try {
            ...
            while (reader.hasNext()) {
                scrapArrayList.add(readMessage(reader));
