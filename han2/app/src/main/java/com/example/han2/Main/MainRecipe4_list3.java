...
import com.example.han2.Atask.MainRecipe4list3;
...
public class MainRecipe4_list3 extends Fragment {
    MainRecipe4list3 mainRecipe4List3;
    MainRecipe4list3Adapter adapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_recipe4_list3, container, false);
        ...
        adapter = new MainRecipe4list3Adapter(arrayList);
        ...
        mainRecipe4List3 = new MainRecipe4list3(arrayList, adapter);
        mainRecipe4List3.execute();
