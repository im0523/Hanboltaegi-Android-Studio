...
public class MainRecipe2list2Adapter extends RecyclerView.Adapter<MainRecipe2list2Adapter.ViewHolder> implements ClickListener {
    ArrayList<WeekRecipeDTO> arrayList;
    ClickListener listener;

    public MainRecipe2list2Adapter(ArrayList<WeekRecipeDTO> arrayList) {
