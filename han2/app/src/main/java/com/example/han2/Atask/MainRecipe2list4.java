...
public class MainRecipe2list4 extends AsyncTask<Void, Void, Void> {
    ...
    public MainRecipe2list4(ArrayList<WeekRecipeDTO> arrayList, MainRecipe2list4Adapter adapter) {
    ...
    protected Void doInBackground(Void... voids) {
        try {
            ...
            String postURL = CommonMethod.ipConfig + "/maincat2s3Recipe";
            // 전송
