...
import com.example.han2.Atask.MainRecipe3list3;
...
public class MainRecipe3_list3 extends Fragment {
    MainRecipe3list3 mainRecipe3List3;
    MainRecipe3list3Adapter adapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_recipe3_list3, container, false);
        ...
        adapter = new MainRecipe3list3Adapter(arrayList);
        ...
        mainRecipe3List3 = new MainRecipe3list3(arrayList, adapter);
        mainRecipe3List3.execute();
