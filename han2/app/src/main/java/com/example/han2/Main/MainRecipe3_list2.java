...
import com.example.han2.Atask.MainRecipe3list2;
...
public class MainRecipe3_list2 extends Fragment {
    MainRecipe3list2 mainRecipe3List2;
    MainRecipe3list2Adapter adapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_recipe3_list2, container, false);
        ...
        adapter = new MainRecipe3list2Adapter(arrayList);
        ...
        mainRecipe3List2 = new MainRecipe3list2(arrayList, adapter);
        mainRecipe3List2.execute();
