...
public class MyRecipe extends AsyncTask<Void, Void, Void> {
    private  static  final String TAG = "MyRecipe";

    //생성자
    ArrayList<MyRecipeDTO> RecipeArrayList;
    RecipeAdapter adapter;
    String userid;

    public MyRecipe(ArrayList<MyRecipeDTO> recipeArrayList, RecipeAdapter adapter, String userid) {
    ...
    protected Void doInBackground(Void... voids) {
        ...
        try {
            ...
            String postURL = ipConfig + "/MyRecipe";
    ...
    public void readJsonStream(InputStream inputStream) throws IOException {
        ...
        try {
            ...
            while (reader.hasNext()) {
                RecipeArrayList.add(readMessage(reader));
            }
            Log.d(TAG, "RecipeArrayList: " + RecipeArrayList.size());
            reader.endArray();
        } finally {
            reader.close();
        }
    ...
    public MyRecipeDTO readMessage(JsonReader reader) throws IOException {
        ...
        reader.endObject();
        Log.d("myrecipe", title + ',' + writedate);
        return new MyRecipeDTO(nickname, title, recipe_id, subtitle, portion, time, cat1, cat2, cat3, cat4, degree, writedate, pid, good, scrap, imagepath, image1, image2, image3, image4, image5, image6, image7, image8, image9, image10, text1, text2, text3, text4, text5, text6, text7, text8, text9, text10, material_name0, material_unit0, material_name1, material_unit1, material_name2, material_unit2,
                material_name3, material_unit3, material_name4, material_unit4, material_name5, material_unit5,
                material_name6, material_unit6, material_name7, material_unit7, material_name8, material_unit8,
                material_name9, material_unit9, material_name10, material_unit10, material_name11, material_unit11,
