...
public class MainRecipe4list2 extends AsyncTask<Void, Void, Void> {
    ...
    public MainRecipe4list2(ArrayList<WeekRecipeDTO> arrayList, MainRecipe4list2Adapter adapter) {
    ...
    protected Void doInBackground(Void... voids) {
        try {
            ...
            String postURL = CommonMethod.ipConfig + "/maincat4s2Recipe";
            // 전송
